...
public class window_triangle {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					window_triangle window = new window_triangle();
	...
	private void initialize() {
		...
		JLabel lblNewLabel = new JLabel("Side 1");
		...
		gbc_lblNewLabel_3.gridheight = 5;
		gbc_lblNewLabel_3.insets = new Insets(0, 0, 5, 0);
		gbc_lblNewLabel_3.gridx = 6;
		gbc_lblNewLabel_3.gridy = 2;
		frame.getContentPane().add(lblNewLabel_3, gbc_lblNewLabel_3);
		
		lblNewLabel_1 = new JLabel("Side 2");
		...
		lblNewLabel_2 = new JLabel("Side 3");
